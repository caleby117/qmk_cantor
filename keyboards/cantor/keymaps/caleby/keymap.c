...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = LAYOUT_split_3x6_3(
        ...
        KC_LSFT, KC_NO,   KC_NO,   KC_NO,  TO(2),     KC_NO,                             KC_NO,   S(KC_MINS), KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,
                                            TO(0),   LCTL_T(KC_SPC), KC_BSPC,  KC_ENT, KC_SPC, TO(1)
    ),
    ...
    //                                         TO(0),   LCTL_T(KC_SPC), KC_MS_BTN1,  KC_MS_BTN2, KC_SPC, TO(1)
    // ),
